...
$query="INSERT INTO locations (id, name, longitude, latitude) VALUES (null, 'look', '$looklat', '$looklng')";
$query2="INSERT INTO locations (id, name, longitude, latitude) VALUES (null, 'start', '$startlat', '$startlng')";
$query3="INSERT INTO locations (id, name, longitude, latitude) VALUES (null, 'stop', '$stoplat', '$stoplng')";
